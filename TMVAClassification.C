...
void TMVAClassification(TString myMethodList = "", TString fname="", TString foutname="") {
   ...
   TTree *signalTree     = (TTree*)input->Get("tr");
   TTree *background     = (TTree*)input->Get("tr");

   // Create a ROOT output file where TMVA will store ntuples, histograms, etc.
   TString outfileName(Form("%s",foutname.Data()));
