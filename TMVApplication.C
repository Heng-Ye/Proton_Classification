...
void TMVApplication(TString myMethodList, TString fname, TString foutname) {
	cout << endl;
	...
	//book the MVA classifier(s) --------------------------------------------------------------------------------------------------//
	string dir    = "dataset/weights/";
	...
	//Book output histograms (purity, efficiency, ...) here ----------------------------------------------------------// 
	UInt_t nbin = 100;
	...
	//Double_t PID_;
	//Double_t B_;
	//Double_t mediandedx_;
	//Double_t endpointdedx_;
	//Double_t calo_;
	//Double_t avcalo_;
	//Double_t costheta_;
